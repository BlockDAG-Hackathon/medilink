...
class BodychartHeatmap extends StatefulWidget {
  ...
  @override
  State<BodychartHeatmap> createState() => _BodychartHeatmapState();
}

class _BodychartHeatmapState extends State<BodychartHeatmap> {
  String? _hoveredPart;
  String? _activePart;
  ...
  String? _hitTestPath(ui.Offset localTapOffset) {
    final scaleFactor = widget.width / BodychartHeatmap.svgViewBoxWidth;
  ...
  Widget _buildInteractiveSvg() {
    _parseSvgPaths();
    final double scaleFactor = widget.width / BodychartHeatmap.svgViewBoxWidth;
    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        child: SizedBox(
          width: widget.width,
          height: BodychartHeatmap.svgViewBoxHeight * scaleFactor,
