...
class AppPages {
  ...
  static final List<GetPage> routes = [
    ...
    GetPage(
      name: passphrase, 
      page: () => NewWalletScreen(),
    ),
    GetPage(
      name: confirmBackup, 
      page: () => SecretPhraseIntroScreen(),
    ),
    GetPage(
      name: generatePassphrase, 
      page: () => GeneratePhrasesScreen(),
    ),
    GetPage(
      name: confirmPhrase, 
      page: () => ConfirmSeedPhrasesScreen(),
    ),
    GetPage(
      name: completeWalletAuth, 
      page: () => CompletedAuthScreen(),
    ),
  ];
}